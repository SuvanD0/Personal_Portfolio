      ...
      return (
        <>
          ...
          <a
            ...
            className="text-sage-moss hover:opacity-80 transition-opacity font-medium"
          >
            {spotifyData.title}
          </a>
      ...
      <main className="max-w-3xl mx-auto px-6 py-6 space-y-16">
        ...
        <section className="mb-8">
          <div className="mb-6">
            ...
            <p className="mt-4 text-muted-foreground leading-relaxed">
              Im originally from the Midwest. I spend my free time exploring new places, listening to <a href="https://www.last.fm/user/Suvan_Dommeti" target="_blank" rel="noopener noreferrer" className="font-semibold text-sage-moss hover:opacity-80 transition-opacity">music</a>, or folding origami.
            </p>
            <p className="mt-4 text-muted-foreground leading-relaxed">
              {getSpotifyText()}
            </p>
